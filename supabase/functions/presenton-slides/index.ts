...
function imageTypeMapping(style: string): string {
  switch(style.toLowerCase()) {
    case 'illustrations': return 'ai-generated';
    case 'photography': return 'stock';
...
const presentonPayload: Record<string, unknown> = {
  ...
  image_type: imageTypeMapping(effectiveImageStyle), 
